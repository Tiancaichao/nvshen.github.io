;(function (window) {
  ...
  let texts = ['茉茉','今天是我们认识第36天了吧','如果从游戏加好友开始算的话有两个多月了','总之很开心能认识你','咳咳..我也被你搞紧张了','接下来进入正题','做好拒绝的准备啊','蔚蓝星空下', '男孩独自坐望', '星海闪烁', '仿佛在问', '为什么你一个人', '那是因为我在等一个人', '一个女孩', '这个女孩', '真的很好看',  '脾气好', '人也好', '但是性格很倔强','但男孩觉得', '这只是个表面', '在他的眼中', '女孩任性起来', '耍起混来的时候', '真的很可爱', '可是', '就是这样单纯的她', '偶尔也会非常脆弱吧', '也有', '伤心难过的时候', '而男孩', '看着她', '想要做一千件事', '让她开心起来', '却总是放下', '已经攥紧的拳头',  '因为男孩知道', '女孩心中有个人', '那是一座女孩', '筑起的城堡', '男孩走不近', '只能呆呆望着', '其实他也知道', '这样很傻', '但是放下', '却做不到', '在城堡外', '继续等待', '男孩再次抬头', '望向星空', '嘿', '女孩', '我能成为', '你的星星吗', '小小的星光', '不过分炙热', '不会灼伤你', '让你耍赖', '给你依赖', '给你幸福', '等待着你', 'Always','可以做我女朋友吗']
